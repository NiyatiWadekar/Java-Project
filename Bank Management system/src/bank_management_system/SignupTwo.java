package bank_management_system;
	...
	public class SignupTwo extends JFrame implements ActionListener{
		...
		SignupTwo(String formno){
			...
			additionalDetails.setFont(new Font("Raleyway", Font.BOLD, 22));
			...
			String educationcategory[] = {"Non-Graduate", "Graduate", "Post-Graduate", "Doctarate", "Other"};
			...
			add(marital);
			String occupationvalues[] = {"Employee", "Bussiness", "Self-Emplyed", "Retired", "Student", "Other"};
			...
			add(address);
			pan = new JTextField();
			pan.setFont(new Font("Raleyway", Font.BOLD, 14));
			...
			aadhar.setFont(new Font("Raleyway", Font.BOLD, 14));
			...
			ButtonGroup maritalgroup = new ButtonGroup(); //this created to either click on male or female
			...
			ButtonGroup emaritalgroup = new ButtonGroup(); //this created to either click on male or female
